# Tarefa 7B - Migração de TypeORM para SQLite puro
...
## Instalação
Para instalar e rodar este projeto, clone este repositório e navegue para a pasta do projeto ([projeto_crud](https://github.com/joviprata/trainee3/tree/Tarefa-7B-Joao-Victor-Prata/Joao-Victor-Prata/Tarefa-7B/projeto_crud)). Siga as instruções apresentadas no [README.md gerado pelo NestJS](https://github.com/joviprata/trainee3/tree/Tarefa-7B-Joao-Victor-Prata/Joao-Victor-Prata/Tarefa-7B/projeto_crud#readme).
